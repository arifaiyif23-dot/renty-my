...
export type Database = {
  ...
  public: {
    Tables: {
      ...
      notification_preferences: {
        Row: {
          ...
          rental_requests: boolean | null
          rental_updates: boolean | null
          reviews: boolean | null
          updated_at: string
          user_id: string
          verification_updates: boolean | null
        }
        Insert: {
          created_at?: string
          email_enabled?: boolean | null
      ...
      profiles: {
        Row: {
          ...
          total_rentals_completed: number | null
      ...
      rentals: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "rentals_promo_code_id_fkey"
            columns: ["promo_code_id"]
            isOneToOne: false
            referencedRelation: "promo_codes"
            referencedColumns: ["id"]
      ...
      verification_requests: {
        Row: {
          ...
          id: string
          identity_number_validated: boolean | null
    ...
    Functions: {
      ...
      create_rental_with_overlap_check: {
        Args: {
          p_end_date: string
          p_item_id: string
          p_owner_id: string
