...
const BADGE_CONFIG: Record<BadgeKind, {
  ...
  dijamin: {
    ...
    base: "bg-emerald-50 text-emerald-700 border-emerald-200 dark:bg-emerald-950/30 dark:text-emerald-400 dark:border-emerald-800",
  },
  lokal: {
    label: "Lokal Malaysia",
    icon: MapPin,
    description: "Local Malaysian owner",
    base: "bg-blue-50 text-blue-700 border-blue-200 dark:bg-blue-950/30 dark:text-blue-400 dark:border-blue-800",
  },
  verified: {
    label: "Verified",
    icon: BadgeCheck,
  ...
  "top-rated": {
    ...
    base: "bg-amber-50 text-amber-700 border-amber-200 dark:bg-amber-950/30 dark:text-amber-400 dark:border-amber-800",
  },
};
