  ...
  theme: {
    ...
    extend: {
      ...
      colors: {
        ...
        'malaysia-blue': 'hsl(var(--malaysia-blue))',
        'malaysia-red': 'hsl(var(--malaysia-red))',
        'malaysia-yellow': 'hsl(var(--malaysia-yellow))',
        primary: {
      ...
      animation: {
        ...
        enter: 'fade-in 0.24s ease-out, scale-in 0.2s ease-out'
      },
      scale: {
        '98': '0.98',
        '102': '1.02'
